...
# tag_dict = {
#     "istp": {"id": 21, "description": "実践的、分析的、好奇心旺盛"},
#     "istj": {"id": 20, "description": "責任感が強い、実務的、組織的"},
#     "isfp": {"id": 19, "description": "芸術的、平和的、冒険的"},
#     "isfj": {"id": 18, "description": "思いやり, 忠実, 伝統的"},
#     "intp": {"id": 17, "description": "知的、好奇心旺盛、理論的"},
#     "intj": {"id": 15, "description": "戦略的、独立的、革新的"},
#     "infp": {"id": 14, "description": "理想主義的、感情的、創造的"},
#     "infj": {"id": 13, "description": "洞察力、理想主義、創造性"},
#     "estp": {"id": 12, "description": "エネルギッシュ、社交的、現実的"},
#     "estj": {"id": 11, "description": "効率的、実践的、リーダー"},
#     "esfp": {"id": 10, "description": "活発、楽しいことが好き、適応力がある"},
#     "esfj": {"id": 9, "description": "協調性がある、温かい、組織的"},
#     "enfj": {"id": 5, "description": "説得力、利他的、調和的"},
#     "enfp": {"id": 6, "description": "熱心、創造的、社交的"},
#     "entj": {"id": 7, "description": "自信、決断力、リーダー"},
#     "entp": {"id": 8, "description": "独創的, 独創的, 論証的"}
# }
